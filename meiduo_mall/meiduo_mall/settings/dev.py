...
CRONJOBS = [
    ...
    ('*/5 * * * *', 'contents.crons.generate_static_index_html',
     '>> /Users/zhangyang/Desktop/Git/MDShop/meiduo_mall/logs/crontab.log')
]
...
# Haystack 配置使用的引擎为 此处为elasticsearch
HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.elasticsearch_backend.ElasticsearchSearchEngine',
        'URL': 'http://114.116.247.86:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
...
# 支付宝
ALIPAY_DEV_APPID = 2016101400687173
ALIPAY_DEV_URL = "https://openapi.alipaydev.com/gateway.do"

ALIPAY_APPID = 2019111369144148
